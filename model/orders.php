        ...
        <div>
            ...
            <div class="mt-6">
                ...
                foreach ($order_details as $orderDetail) {
                    ...
                    <div class="flex items-center space-x-3">
                        <img src="<?php echo $client_side ? "./upload/" : "../upload/" ?>
                <?php echo $image ?>" alt="" class="w-[90px] h-[70px] rounded-md">
                        <div class="flex flex-col space-y-2">
                            <p class="text-sm font-medium">
                                <?php echo $product_name ?>
                            </p>
                            <p class="text-sm font-medium">Qty:
                                <?php echo $quantity ?>
                            </p>
                            <p class="text-sm font-medium">Price: $
                                <?php echo $price_per_unit ?>
                            </p>
                        </div>
                    </div>
            ...
            <div class="flex flex-col space-y-6 my-8">
                <div class="flex items-center">
                    ...
                    <div
                        class="capitalize badge text-white text-xs px-2 py-1 <?php echo $order['payment_methods'] === 'payment on delivery' ? 'bg-blue-500' : '' ?> <?php echo $order['payment_methods'] === 'online payment' ? 'bg-green-500' : '' ?>">
                ...
                <div class="flex items-center">
                    ...
                    <div
                        class="capitalize badge text-white text-xs px-2 py-1 <?php echo $order['payment_status'] === 'Processing' ? 'bg-orange-500' : '' ?> <?php echo $order['payment_status'] === 'Succeeded' ? 'bg-green-500' : '' ?> <?php echo $order['payment_status'] === 'Return' ? 'bg-red-500' : '' ?>">
