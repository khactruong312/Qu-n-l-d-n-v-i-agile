        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div class="preview-image mb-4">
                <img class="w-[150px] h-[150px] object-cover rounded-md"
                    src="../<?php echo $image_path . $billboard['image_url']; ?>" alt="">
            </div>
            <div class="flex flex-col space-y-2 w-2/3">
                <div class="flex flex-col space-y-2 w-full md:w-2/3 mb-6">
                    ...
                    <input class="image-upload p-2 bg-neutral-100 rounded-md cursor-pointer" id="image_url"
            ...
            <div class="grid md:grid-cols-2 grid-cols-1 gap-4">
                <div class="flex flex-col space-y-2">
                    ...
                    <input type="text" class="form-input rounded text-slate-900" name="title" id="title"
                        placeholder="Example: wellcome halloween" value="<?php echo $billboard['title']; ?>" />
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <input type="text" class="form-input rounded text-slate-900" name="subtitle" id="subtitle"
                        value="<?php echo $billboard['subtitle']; ?>" />
            ...
            <button class="btn md:btn-md btn-sm capitalize rounded-full bg-slate-700 hover:bg-slate-900 text-white mt-5"
                type="submit" name="update_billboard">Update billboard</button>
