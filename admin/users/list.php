<div class="animate__animated animate__lightSpeedInLeft animate__faster ">
    <div class="w-full mt-4">
        ...
        <form id="form-user-search" class="flex flex-col md:flex-row items-start md:items-center space-y-4 md:space-y-0 md:space-x-4" action="index.php?act=list_user" method="post">
            <div class="flex-grow">
                ...
                <div class="flex">
                    <input type="text" name="keyword" id="keyword" class="form-input w-50" placeholder=" Enter Username...">
                    <button type="submit" name="filter" class="btn btn-sm bg-slate-700 hover:bg-slate-800 text-white ml-2">
    ...
    <a class="btn md:btn-md btn-sm bg-slate-700 hover:bg-slate-900 text-white  " href="index.php?act=add_user">
