        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4">
                <div class="flex flex-col space-y-2">
                    ...
                    <input type="text" class="form-input text-slate-900" name="name" id="name" placeholder="Example: Gucci" />
            ...
            <button class="btn md:btn-md btn-sm capitalize bg-slate-700 hover:bg-slate-900 text-white mt-5" type="submit" name="add_brand">Add brand</button>
        </form>
    </div>
</div>